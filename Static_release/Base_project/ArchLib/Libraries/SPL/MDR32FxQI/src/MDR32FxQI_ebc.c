...
#if defined (USE_MDR32F1QI) || defined (USE_MDR1986VE94GI)
...
/**
  ...
  * @warning This function can be used only for MCU MDR32F1QI and MDR1986VE94GI
...
#endif /* defined (USE_MDR32F1QI) || defined (USE_MDR1986VE94GI) */
