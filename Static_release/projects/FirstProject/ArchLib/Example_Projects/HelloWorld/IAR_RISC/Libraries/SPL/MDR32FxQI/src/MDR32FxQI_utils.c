...
#if defined (USE_MDR32F9xI) || defined(USE_MDR32F1QI)
...
typedef struct
{
    ...
    MDR_PORT_TypeDef*        STDIO_UART_PORTx;      /*!< Select the MDR_PORTx peripheral with UART function. x can be:
                                                          - (A, B, D, F) for MDR32F9Q2I, MDR1986VE94GI;
    ...
    else
    {
        ...
        switch (DelayMode)
        {
            ...
            case DELAY_MODE_TIMER4:
                ...
                break;
#elif ((defined (USE_MDR32F9xI)) || (defined (USE_MDR32FG16S1QI)))
            case DELAY_MODE_DWT:
                DELAY_DWT_Init();
                break;
#endif
...
/**
  ...
  *                               Us <= 25177000 / CPU_CLK (MHz) for MDR32F9Q2I, MDR1986VE94GI;
  *                               Us <= 33569000 / CPU_CLK (MHz) for MDR32F1QI;
...
/**
  ...
  *                               Ms <= 25769000 / CPU_CLK (MHz) for MDR32F9Q2I, MDR1986VE94GI;
  *                               Ms <= 34359000 / CPU_CLK (MHz) for MDR32F1QI;
...
/**
  ...
  *             1, 2, 3 for MDR32F9Q2I, MDR1986VE94GI and MDR32FG16S1QI;
 ...
 * @param  STDIO_UARTx: Select the UART peripheral.
  ...
  *            1, 2 for MDR32F9Q2I, MDR1986VE94GI and MDR32F1QI;
