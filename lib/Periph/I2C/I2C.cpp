...
void I2C::CreateUi(QMainWindow *pointer_class_Ui, uint16_t offset_mode_x, uint16_t offset_mode_y, uint16_t offset_settings_x, uint16_t offset_settings_y)
{
...
QJsonObject I2C::CreateJsonObject()
{
...
void I2C::ReadJsonValue(QJsonValue jv)
{
    this->On = jv.toObject().value("On").toInt();
}

void I2C::CreateModeUi(QMainWindow *pointer_class_Ui, uint16_t offset_x, uint16_t offset_y)
{
...
void I2C::CreateSettingsUi(QMainWindow *pointer_class_Ui, uint16_t offset_x, uint16_t offset_y)
{
